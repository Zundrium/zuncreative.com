...
>
	<div role="status">
		<svg aria-hidden="true" class="w-16 h-16 text-gray-200 animate-spin dark:text-neutral-600 fill-neutral-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<canvas
	...
	class="pointer-events-none lg:pointer-events-auto w-full h-full opacity-0 transition-opacity duration-2000 {initialized
		? 'opacity-100'
		: ''}"
></canvas>
