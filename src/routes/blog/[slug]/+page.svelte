...
>
	{#key post}
	<article class="prose lg:prose-xl dark:prose-invert prose-strong:font-extralight max-w-full md:max-w-prose prose-pre:overflow-x-auto prose-pre:pe-0 prose-pre:ps-0">
		{@html post.html}
	</article>
	{/key}
</Section>
...
>
		...
		>
			<a href="/blog/{relatedPost.slug}" class="relative cursor-pointer w-full aspect-4/2 overflow-hidden" data-cursor-icon="fullscreen" use:viewportSlideInBottom> 
				<Image
					parallax
